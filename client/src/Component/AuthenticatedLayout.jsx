          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              ...
              <div className="flex items-center gap-3 group cursor-pointer">
                ...
                <div>
                  <h2 className="text-xl font-bold gold-text-gradient font-cinzel tracking-wide">SavoryBites</h2>
                  <p className="text-[9px] text-yellow-600/70 uppercase tracking-[0.2em] font-medium">Restaurant Management</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="hidden md:block relative">
                  <button
                    ...
                    className={`flex items-center gap-3 px-3 py-1.5 rounded-full border transition-all duration-300 ${isProfileOpen ? 'bg-yellow-900/10 border-yellow-500/50' : 'bg-transparent border-transparent hover:border-yellow-600/30'}`}
                  >
                    ...
                    <div className="text-left hidden lg:block">
                      <p className="text-xs font-semibold text-yellow-100 tracking-wide">{name || 'User'}</p>
                      <p className="text-[9px] text-yellow-600/80 uppercase tracking-wider">{role || 'Guest'}</p>
                    </div>
