...
import { useToast } from "../context/ToastContext"; // Add toast for feedback
...
const Welcome = () => {
 ...
 const handleContinueAsGuest = async () => {
    try {
        // FIX: Wait for the session to be created in Redux/Backend
        // Assuming your slice returns the payload on fulfillment
        const result = await dispatch(session({ deviceId: "web_client", qrSlug: getqrSlug })).unwrap();
        
        // Ensure token is set before navigation (Redux slice handles localStorage, but let's be safe)
