...
import { UtensilsCrossed, UserPlus, LogIn, User, Sparkles, ChevronRight, Star } from 'lucide-react';
          ...
          <div className="gold-border-gradient rounded-2xl shadow-2xl backdrop-blur-sm bg-black/60 pt-10 pb-8 px-8">
            ...
            <div className="text-center mb-10 space-y-2">
              ...
              <div className="flex items-center justify-center gap-2 opacity-60 mb-2">
                ...
                <span className="text-[10px] uppercase tracking-[0.3em] text-yellow-500">Est. 2024</span>
                <div className="h-[1px] w-8 bg-yellow-700"></div>
              </div>
            ...
            <div className="space-y-4 mb-10">
              ...
              >
                ...
                <div className="relative flex items-center gap-3 text-[#291d0a]">
                  ...
                  <span className="font-cinzel font-bold tracking-wide text-base">Register Now</span>
                </div>
              </Link>
              ...
              >
                <div className="relative flex items-center gap-3 text-[#e2cf9d] group-hover:text-[#FCF6BA] transition-colors">
                  ...
                  <span className="font-manrope font-semibold tracking-wider text-sm uppercase">Member Login</span>
                </div>
                {/* Arrow hint on hover */}
...
hover:bg-gradient-to-b hover:from-[#0A0A0A] hover:via-black hover:to-[#0A0A0A]"
              ...
              >
                ...
                <span className="border-b border-transparent group-hover:border-yellow-500/50 pb-0.5">Continue as Guest</span>
              </button>
            </div>
              ...
              <div className="grid grid-cols-2 gap-y-3 gap-x-2">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-400 font-manrope font-light">{text}</span>
                  </div>
                ))}
              </div>
            </div>
